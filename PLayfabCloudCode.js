...
handlers.newUserRegistered = function(args){
    var contentBody ={ "content": "New User REgister"};
    var url ="https://discord.com/api/webhooks/1265382530652180550/MlPVYG3zm9XS6T8nXp0V0Ob3nt7EYVWV2-KiMXwMeKA7eQlHv0n2ndayO3UKGqD0RLRD";
    var method = "post";
...
handlers.validateScore = function(args){
    var score = args.score;

    if(score > 100){
         var contentBody ={ "content": "Cheater Found" + currentPlayerId};
         var url ="https://discord.com/api/webhooks/1265382530652180550/MlPVYG3zm9XS6T8nXp0V0Ob3nt7EYVWV2-KiMXwMeKA7eQlHv0n2ndayO3UKGqD0RLRD";
        var method = "post";
        var contentType = "application/json";
        var headers = {};
...
handlers.sendFeedback = function(args){
